...
const PageTitle = ({ title, pageDiscriptionRequired, pageDiscriptionLine1, pageDiscriptionLine2 }) => {
  return (
    <div className='grid items-start font-semibold'>
      ...
      <hr className='m-1 mr-10 ml-0 md:ml-5 lg:ml-5 lg:ml-20 lg:mr-20 border-black' />

      {
        pageDiscriptionRequired === 'yes' &&

        <div className='text-left md:text-center lg:text-center font-medium text-xs md:text-sm lg:text-md xl:text-lg w-full'>
