...
const Skills = () => {
  ...
  const skillsObj = {
    ...
    'Next.js': <SiNextdotjs />,
    'Django & Django Rest Framework': <img src="https://img.icons8.com/color/100/django.png" alt={<DiDjango />}/>,
    'REST API': <img src="https://img.icons8.com/fluency/100/api-settings.png" alt='api-settings'/>,
