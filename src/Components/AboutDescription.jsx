...
const AboutDescription = () => {
    return (
        <div className='text-left md:text-center lg:text-center text-balance'>
            <div className='text-sm md:text-md lg:text-lg xl:text-xl text-slate-600 font-extrabold font-bold font-serif'>
