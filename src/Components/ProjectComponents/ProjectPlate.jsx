                ...
                <div className='w-full h-full rounded-lg animate-zoomIn' style={{
                ...
                }}>
                    {
                        ...
                        isHovered ?
                            ...
                            <div className='grid justify-items-center items-center font-semibold text-xs md:text-sm lg:text-md xl:text-lg text-slate-800 text-center bg-gradient-to-t from-violet-500 to-violet-100 opacity-90 h-full w-full rounded-lg pl-2 pr-2 md:pl-4 md:pr-4 lg:pl-6 lg:pr-6 text-balance animate-zoomIn'>
                                {description}
                            </div>
            ...
            <div className='row-span-1 flex justify-center items-center gap-2'>
                {
                    languagesUsed.map((language, index) => (
                        <span key={index} className='text-lg md:text-2xl lg:text-2xl xl:text-2xl h-6 w-6 md:h-6 md:w-6 lg:h-8 lg:w-8 rounded-3xl drop-shadow-2xl'>
                            {language}
                        </span>
                    ))
                }
