...
const PersonalDetails = () => {
  return (
    <div className='grid grid-flow-row gap-2 justify-end content-start font-semibold text-slate-900 text-balance text-xs md:text-md lg:text-md xl:text-lg py-4'>
      ...
      <span>- BSc.IT Graduate, Year - 2023</span>
      <span>- Certified Python Programmer</span>
      <span>- Internship - 6 months & Freelance React projects</span>
      <span>- 11th June, 2002</span>
      <span>- India, Maharashtra Mumbai - 400007</span>
    </div>
  )
}
