  ...
  return (
    <div id='Home' className=' grid grid-rows-3 content-center h-dvh pt-10 md:pt-20 lg:pt-20 bg-gradient-to-b from-indigo-300 to-indigo-200' >
      ...
      <div className='grid justify-items-center content-start md:content-end lg:content-end pl-12 md:pl-20 lg:pl-0 text-left md:text-center lg:text-center'>
        <div className='text-xs md:text-sm lg:text-lg xl:text-xl text-slate-700 font-extrabold font-serif' data-aos-offset="90" data-aos-mirror="true" data-aos='zoom-out'> "Dedicated to grow & evolve with curiosity & creativity in the world of web development." </div>
        <div className='text-xs md:text-sm lg:text-md xl:text-lg text-slate-600 font-medium' data-aos-offset="90" data-aos-mirror="true" data-aos='zoom-out'> I am a <b className='text-violet-950'>full stack developer</b> with a strong foundation in <b className='text-violet-950'>React.js & Python, </b> along with an experience in all the technical skills mentioned. </div>
      </div>
